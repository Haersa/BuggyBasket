...
export const metadata = {
  title: 'Terms & Conditions — Buggy Basket',
  description: 'Terms and Conditions for Buggy Basket.',
};
...
export default function TermsPage() {
  return (
    <PolicyLayout
      ...
      warning="This is a draft of the Terms & Conditions generated by FreePrivacyPolicy. Please review and replace with final legal text approved by the team/lawyer before going live."
      tocItems={[
    ...
    >
      ...
      <PolicySection title="Interpretation and Definitions">
        ...
        <ul>
          ...
          <li><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in these Terms and Conditions) refers to Buggy Basket, Thurso, Scotland, UK.</li>
          <li><strong>Device</strong> means any device that can access the Service such as a computer, a cell phone or a digital tablet.</li>
          <li><strong>Service</strong> refers to the Website.</li>
          <li><strong>Terms and Conditions</strong> (also referred to as &quot;Terms&quot;) means these Terms and Conditions that govern Your access to and use of the Service and form the entire agreement between You and the Company.</li>
      ...
      <PolicySection title="Acknowledgment">
      ...
      <PolicySection title="Links to Other Websites">
        ...
        <PolicyHeading>Links from a Third-Party Social Media Service</PolicyHeading>
        ...
        <p>You acknowledge and agree that the Company shall not be responsible or liable, directly or indirectly, for any damage or loss caused or alleged to be caused by or in connection with Your access to or use of any Third-Party Social Media Service.</p>
      </PolicySection>
      ...
      <PolicySection title='"AS IS" and "AS AVAILABLE" Disclaimer'>
      ...
      <PolicySection title="Disputes Resolution">
        <p>If You have any concern or dispute about the Service, You agree to first try to resolve the dispute informally by contacting the Company.</p>
      </PolicySection>

      <PolicySection title="Severability and Waiver">
        <PolicyHeading>Severability</PolicyHeading>
        <p>If any provision of these Terms is held to be unenforceable or invalid, such provision will be changed and interpreted to accomplish the objectives of such provision to the greatest extent possible under applicable law and the remaining provisions will continue in full force and effect.</p>

        <PolicyHeading>Waiver</PolicyHeading>
        <p>Except as provided herein, the failure to exercise a right or to require performance of an obligation under these Terms shall not affect a party&apos;s ability to exercise such right or require such performance at any time thereafter nor shall the waiver of a breach constitute a waiver of any subsequent breach.</p>
      </PolicySection>

      <PolicySection title="Changes to These Terms and Conditions">
