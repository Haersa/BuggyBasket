    ...
    return (
      <div className="page">
        <div className="page-container">
          ...
          <h1 className="legal-spacing">Terms and Conditions</h1>
     

        <p><strong>IMPORTNANT Temporaty Content </strong> <br />
        This is a draft of the Terms and Conditions generated by FreePrivacyPolicy.<br />
        ...
        <p className="legal-spacing">Please read these terms and conditions carefully before using Our Service.</p>
        
        <h2 className="legal-spacing">Interpretation and Definitions</h2>
        
        <h3>Interpretation</h3>
        
        <p className="legal-spacing">The words whose initial letters are capitalized have meanings defined under the following conditions. The following definitions shall have the same meaning regardless of whether they appear in singular or in plural.</p>
        ...
        <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in these Terms and Conditions) refers to Buggy Basket, Thurso, Scotland, UK.</p>
        ...
        <li>By email: buggybasket@gmail.com</li>
